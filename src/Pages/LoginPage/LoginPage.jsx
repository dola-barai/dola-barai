            ...
            <div className="hero bg-[#F0F1FF] ">
                <div className="hero-content flex-col">
                    <div className="bg-[#FFFFFF] w-[515px] h-[744px] rounded-[15px] my-12 px-6 py-[22px]" >
                        <div className="">
                            <h1 className="text-4xl font-semibold mb-7">Sign in</h1>
                            ...
                            <div className=" ">
                                <button className="w-[464px] h-[41px] bg-[#000AFF] text-white rounded-[8px] text-xl">Continue</button>
                            </div>
                            <div className="text-center my-6 text-2xl text-[#888888]">or</div>
                            <div className="mb-6">
                                <button className="btn w-[464px] bg-white text-center h-[48px] normal-case border-[#B6B6B6] border-[1px] text-[#B6B6B6] rounded-[8px] text-xl"><PiFacebookLogo className="h-7 w-7" />Continue with Facebook</button>
                            </div>
                            <div className="mb-6">
                                <button className="btn w-[464px] bg-white text-center h-[48px] normal-case border-[#B6B6B6] border-[1px] text-[#B6B6B6] rounded-[8px] text-xl"><TbBrandGoogle className="h-7 w-7" />Continue with Google</button>
                            </div>
                            <div className="mb-12">
                                <button className="btn w-[464px] bg-white text-center h-[48px] normal-case border-[#B6B6B6] border-[1px] text-[#B6B6B6] rounded-[8px] text-xl"><PiLinkedinLogo className="h-7 w-7" />Continue with LinkedIn</button>
                            </div>
