                ...
                <div className="hero-content flex-col">
                    <div className="bg-[#FFFFFF] w-[515px] h-[834px] rounded-[15px] my-6 px-6 py-[22px]" >
                        <div className="">
                            ...
                            <div className=" ">
                                <button className="w-[464px] h-[36px] bg-[#000AFF] text-white rounded-[8px] text-xl">Next</button>
                            </div>
                            <div className="text-center my-4 text-2xl text-[#888888]">or</div>

                            <div className="mb-20">
                                <button className="btn w-[464px] bg-white text-center h-[48px] normal-case border-[#B6B6B6] border-[1px] text-[#B6B6B6] rounded-[8px] text-xl"><PiLinkedinLogo className="h-7 w-7" />Sign up with LinkedIn</button>
                            </div>
